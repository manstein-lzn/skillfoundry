...
产品主路径还需要继续收敛到这套 v2 骨架，human-review 已有 request / decision artifact 和 API decision endpoint；后续重点是 legacy 最终退役、更完整的 API/UI evidence 体验，以及 internal pilot 前的人审运营体验打磨。
```
