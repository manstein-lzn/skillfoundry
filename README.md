...
1. 按 [docs/SKILLFOUNDRY_CONTEXTFORGE_REFACTOR_PLAN.md](docs/SKILLFOUNDRY_CONTEXTFORGE_REFACTOR_PLAN.md) 的 Phase 3 继续收敛 Front Desk v2 runtime，把 approved-plan audit/freeze 路径接到 Goal Harness Spec Auditor。
2. 让 `graph_v2.py` 成为 build / verify / repair / registry 的产品主骨架，并让 API/UI 消费 v2 refs 和 ContextForge status。
