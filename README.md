...
1. 先修通默认 Front Desk frozen job 到 verified build / verify / acceptance coverage / registry 的离线闭环，重点是 Front Desk 生成的 acceptance criteria 必须能映射到 deterministic verifier check。
