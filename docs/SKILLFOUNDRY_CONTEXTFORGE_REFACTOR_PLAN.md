...
1. `README.md`
2. `docs/SKILLFOUNDRY_V2_BASELINE.md`
3. `docs/CONTEXTFORGE_AGENT_EXOSKELETON_PRODUCT_VISION.md`
4. 本文
5. `docs/CONTEXTFORGE_GOAL_HARNESS_REBUILD_PLAN.md`
6. `third_party/contextforge/README.md`
7. `third_party/contextforge/docs/architecture.md`
8. `third_party/contextforge/docs/goal-harness-quickstart.md`
...
```text
Front Desk 产品路径生成 governed artifacts，等待用户方案审查，只审查 approved plan，并冻结 builder inputs，且 raw conversation 不泄漏。
```
